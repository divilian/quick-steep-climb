...
The answer turns out to be \textbf{\textit{no.}} A $2\times 2$ matrix can only
have two eigenvectors, a fact which turns out to be a pretty big deal in
itself. But that's foreshadowing.
