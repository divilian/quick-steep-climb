...
%    no such thing as scalar-vector addition! (although programming languages
%        give you a convenient shortcut)
%    distributive
%vector addition
%    can't add two vectors of different length / # dimensions
%    if not indexed by number, must have the same domain (index labels)
%    commutative
%    (subtraction)
%vector multiplication (dot product)
%    (a.k.a inner product, sorta)
%    can't multiply two vectors of different length  or w/ diff domain
%    commutative
%
%
%
...
%
%
%what needs to be true about the vectors for me to get a big dot product? big
%    elements? Yes, sorta, but no...
%
%    taking the dot product is a crude way of telling you "how aligned they are"
%
%    matchmaker example
%        (of course, Jezebel could max it out with all 10's and beat the system)
%
%
