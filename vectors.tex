...
Importantly, though, this norm applies equally well in \textit{any} number of
dimensions, not just two. Suppose we had a five-dimensional vector, like this
one:
...
%revisit geometric dot product:
%This brings up a second, equally legitimate way to compute and to think about
%the dot product. 
